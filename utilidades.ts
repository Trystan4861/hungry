// función generateID para generar un ID aleatorio usando Math.random().toString(36).slice(2)
export const generateID = (): string => Math.random().toString(36).slice(2)
export const DOM = (selector: string,    root: Document = document) => root.querySelectorAll(selector)
export const _DOM = (selector: string,    root: Document = document) => root.querySelector(selector)
