...
.dropdown { position: absolute; top: 100%; left: 0; width: 100%; background-color: gray; border: .0625rem solid #ccc; border-top: none; border-radius: 0 0 .25rem .25rem; box-shadow: 0 .125rem .25rem rgba(0, 0, 0, 0.1); z-index: 1000; display: none; }
.dropdown.show { display: block; }
.dropdown .option { padding-left: .625rem; padding-bottom: .625rem; cursor: pointer; }
.dropdown .option:hover { background-color: lightgray; color: black; }
.option { max-height: 3.125rem; }
.my-select img { max-height: 2.8125rem; }
</style>
