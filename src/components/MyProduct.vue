...
const handleRelease     = () => (clearTimeout(longPressTimeout.value), emitDragEnd());
...
const emitDragEnd       = () => (clearInterval(dragInterval.value),dragging = false)
const emitDragStart     = () => (dragging = true,dragInterval.value = setInterval(emitDragDirection, tiempoDrag))
