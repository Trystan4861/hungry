...
export const getChildNodes=ofWhat=>Array.from(ofWhat.childNodes).filter(item=>item.nodeType===1) 

// función para obtener los hijos de un elemento por su ID
export const getChildNodesID=id=>getChildNodes(document.getElementById(id))